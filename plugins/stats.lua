...
local function run(msg, matches)
  if matches[1]:lower() == 'telecloud' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "telecloud" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (telecloud)",-- Put everything you like :)
		"^[!/#]([Tt]ele[Cc]loud)"-- Put everything you like :)
    }, 
  run = run
}
